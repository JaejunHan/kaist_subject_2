...
import com.jackrutorial.test1.Signup;
...
public class DataPickerFragment extends DialogFragment implements DatePickerDialog.OnDateSetListener {
    ...
    public void onDateSet(DatePicker view, int year, int month, int day) {
        ...
        activity.birthdayText.setText(String.valueOf(year) + "년 " + String.valueOf(month + 1) + "월 " + String.valueOf(day) + "일"); // 유저가 선택한 날짜로 버튼 텍스트 변경
        activity.getBirthday(year, month, day);
    }
}